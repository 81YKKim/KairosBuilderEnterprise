...
def test_generated_desktop_dashboard_clears_detail_when_recommendations_empty(
    tmp_path: Path,
):
...
assert dashboard.recommendation_detail.entry_timing_label.objectName() == "entryTimingDefault"
