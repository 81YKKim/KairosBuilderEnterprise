...
def test_generated_desktop_modules_are_importable(
    ...
    try:
        ...
        assert (
            importlib.import_module(
                "desktop.widgets.recommendation_table"
            )
            is not None
        )
        assert (
            importlib.import_module(
                "desktop.widgets.recommendation_detail"
            )
            is not None
        )
        assert (
            importlib.import_module(
                "desktop.viewmodels.dashboard_view_model"
            )
            is not None
        )
        assert (
            importlib.import_module(
                "desktop.services.market_service"
            )
            is not None
        )
        assert (
            importlib.import_module(
                "desktop.adapters.replay_adapter"
            )
            is not None
        )
    finally:
